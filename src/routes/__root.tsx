...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "La Porra del Mundial" },
      { name: "description", content: "Quiniela privada del Mundial entre amigos: pronósticos, ranking y bonus." },
      { property: "og:title", content: "La Porra del Mundial" },
      { property: "og:description", content: "Quiniela privada del Mundial entre amigos: pronósticos, ranking y bonus." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "La Porra del Mundial" },
      { name: "twitter:description", content: "Quiniela privada del Mundial entre amigos: pronósticos, ranking y bonus." },
      ...
      { name: "theme-color", content: "#0a4d2e" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "El Mundial" },
